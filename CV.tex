...
% Social icon overrides (prefer official brand icons if available)
\IfFileExists{fontawesome7.sty}{\usepackage{fontawesome7}}{}
\definecolor{xbrand}{HTML}{000000}
\definecolor{blueskybrand}{HTML}{1185FE}
\makeatletter
\@ifundefined{faXTwitter}
  {\renewcommand*{\twittersocialsymbol}{{\small\textbf{X}}~}}
  {\renewcommand*{\twittersocialsymbol}{{\color{xbrand}\small\faXTwitter}~}}
\@ifundefined{faBluesky}
  {\newcommand*{\blueskysocialsymbol}{{\small\textbf{B}}~}}
  {\newcommand*{\blueskysocialsymbol}{{\color{blueskybrand}\small\faBluesky}~}}
\makeatother
