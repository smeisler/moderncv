\documentclass[12pt,legalpaper,sans]{moderncv} %a4paper
% SET UP BOLD NAME %
\usepackage{xstring}
\usepackage{etoolbox}
\newboolean{bold}
...
\address{Richards Building, 5th Floor. 3700 Hamilton Walk.}{Philadelphia, PA 19103}{USA}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\photo[70pt][0.4pt]{ny_pic_head.png}                       
...
% ---------------------------------------------------------
\makecvtitle
Steven is a developmental neuroscientist whose graduate work used multimodal neuroimaging (fMRI and DWI) and psychocognitive evaluations to study the neural bases of reading abilities, disabilities, and intervention in children. As a postdoctoral fellow at the University of Pennsylvania, he is using large datasets and cutting-edge techniques to investigate white matter developmental trajectories in infancy. He is broadly interested in characterizing early life white matter trajectories, and quantifying the effect of psychiatric risk on white matter maturation. Steven received his bachelor’s and master's degrees in bioengineering from the University of Pennsylvania in 2017 and 2018, and his PhD from Harvard University in Speech and Hearing Bioscience and Technology in May 2024.
...
\printbibliography[title=Published Articles, type=article, keyword={published}, resetnumbers=true]
%\printbibliography[title=Under Review, type=article, keyword={submitted}, resetnumbers=true]
\printbibliography[title=Articles in Review / Revision, type=article, keyword={submitted}, resetnumbers=true]
% ---------------------------------------------------------
\section{Funding}
\subsection{External}
...
\section{Skills}
\cvitem{}{1 - Basic Knowledge; 5 - Expert}
\cvskillhead[-0.1em][Level][Skill][][Comments]
\cvskillentry*{Computing:}{5}{Python}{}{Comfortable with data analysis, Jupyter, and Python-based software development}
\cvskillentry{}{4}{MATLAB}{}{Can use MATLAB if required, but I prefer Python and terminal tools}
\cvskillentry{}{4}{Bash / Terminal}{}{Proficient in scripting and parallelizing jobs with HPC schedulers}
\cvskillentry{}{3}{R}{}{It's a work in progress...}
\cvskillentry{}{4}{\LaTeX}{}{Prefer to write papers using either Overleaf or Google Docs (+Zotero)}
\cvskillentry*[1em]{Methods}{5}{DWI}{}{Familiar with basic tensor and advanced diffusion modeling approaches}
\cvskillentry{}{4}{fMRI}{}{Familiar with several univariate and multivariate analytical approaches}
\cvskillentry{}{2}{EEG Time Series Analysis}{}{Master's thesis heavily employed ML-based analysis of continuous time-frequency decomposition}
\cvitem{}{\textbf{Other Skills}}
\cvdoubleitem{\textbf{Study\\Coordination}}{EPIC, REDCap, IRB}{\textbf{Open Science}}{GitHub, BIDS-apps}
...
\cvitem{(Python/Bash)}{\url{https://github.com/smeisler/fsub_extractor}}
