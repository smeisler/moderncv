...
% Social icon overrides (X/Twitter and optional Bluesky icon if available)
\makeatletter
\@ifundefined{faXTwitter}
  {\renewcommand*{\twittersocialsymbol}{{\small\textbf{X}}~}}
  {\renewcommand*{\twittersocialsymbol}{{\small\faXTwitter}~}}
\@ifundefined{faBluesky}
  {\newcommand*{\blueskysocialsymbol}{{\small\textbf{B}}~}}
  {\newcommand*{\blueskysocialsymbol}{{\small\faBluesky}~}}
\makeatother
